      ...
      <div className="container">
        <div className="flex items-center xl:justify-between justify-center">
          <div className="xl:flex items-center gap-x-6 hidden">
            ...
            <div>
              <ul className="flex items-center gap-x-[19px]">
                <li className="relative group after:absolute after:h-7.5 after:w-px after:bg-primary-light after:right-0 after:top-1/2 after:-translate-y-1/2">
                  <a
                    href="#"
                    className="text-sm leading-[22px] text-white inline-flex items-center gap-x-2 pr-[19px] py-3.5"
                  >
                    <span className="inline-flex items-center justify-center size-7 bg-primary-darker rounded-full">
                      <i className="hgi hgi-stroke hgi-language-circle text-xl text-white" />
                    </span>
                    English
                  ...
                  <ul className="absolute left-0 top-full py-2 z-50 w-[250px] max-w-[250px] bg-white rounded-lg shadow-dark-z-24 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-4 group-hover:translate-y-0">
                    <li className="py-2 px-4 group/item">
                      <a
                        href="#"
                        className="flex items-center gap-x-2 relative text-light-primary-text group-hover/item:text-primary"
                      >
                        <span className="w-8 h-8 bg-[#F0F0F0] group-hover/item:bg-[#00AB55]/8 inline-flex items-center justify-center rounded-full">
                          <svg
                            width={16}
                            height={16}
                            viewBox="0 0 16 16"
                    ...
                    <li className="py-2 px-4 group/item">
                      <a
                        ...
                        className="flex items-center gap-x-2 relative text-light-primary-text group-hover/item:text-primary"
                      >
                        <span className="w-8 h-8 bg-[#F0F0F0] group-hover/item:bg-[#00AB55]/8 transition-colors duration-300 inline-flex items-center justify-center rounded-full">
                          <svg
                            width={16}
                            height={16}
                            viewBox="0 0 16 16"
                ...
                <li className="relative group">
                  <a
                    href="#"
                    className="text-sm leading-[22px] text-white flex items-center gap-x-2 py-3.5"
                  >
                    <span className="inline-flex items-center justify-center size-7 bg-primary-darker rounded-full">
                      <i className="hgi hgi-stroke hgi-dollar-circle text-xl text-white" />
                    </span>
                    USD
                    <span className="inline-flex items-center justify-center">
                      <i className="hgi hgi-stroke hgi-arrow-down-01 text-xl text-white" />
