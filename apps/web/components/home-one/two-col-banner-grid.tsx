...
export default function TwoColBannerGrid() {
  return (
          ...
          >
            <div className="md:items-center flex flex-col md:flex-row md:gap-x-2.5 py-5.5 pl-8.5 pr-10 bg-[#A0E2E0] rounded-2xl">
              ...
              <div className="order-1 md:order-2 md:max-w-80 w-full">
                <Image src="/images/cosmetic-bundle.png" alt="Cosmetic Bundle" width={320} height={320} className="w-full h-auto" />
              </div>
            </div>
          </motion.div>
          <motion.div
            ...
            className="lg:col-span-6 col-span-12"
          >
            <div className="md:items-center flex flex-col md:flex-row md:gap-x-2.5 py-5.5 pl-8.5 pr-10 bg-[#FFEB69] rounded-2xl">
              <div className="order-2 md:order-1">
                <p className="font-semibold text-light-primary-text pb-4">
                  Premium
                </p>
              ...
              <div className="order-1 md:order-2 md:max-w-80 w-full">
                <Image src="/images/power-c.png" alt="Cosmetic Bundle" width={320} height={320} className="w-full h-auto" />
              </div>
            </div>
          </motion.div>
        </div>
